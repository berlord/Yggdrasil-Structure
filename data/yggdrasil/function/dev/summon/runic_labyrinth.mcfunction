        ...
        Recipes:[\
            {\
                buy:{\
                    ...
                    count:5b,\
                    components:{\
                        "minecraft:item_name":'{"fallback":"Labyrinth Key","translate":"item.yggdrasil.runic_labyrinth.key"}',\
                        "minecraft:custom_data":{\
                            yggdrasil:{\
                                id:"yggdrasil.runic_labyrinth.key.normal"\
                            }\
                        }\
                    }\
                },\
            ...
            {\
                buy:{\
                    ...
                    count:3,\
                    components:{\
                        "minecraft:item_name":'{"fallback":"Ominous Labyrinth key","translate":"item.yggdrasil.runic_labyrinth.ominous_key"}',\
                        "minecraft:custom_data":{\
                            yggdrasil:{\
                                id:"yggdrasil.runic_labyrinth.key.ominous_key"\
                            }\
                        }\
                    }\
                },\
