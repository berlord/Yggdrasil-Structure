        ...
        Recipes:[\
            {\
                buy:{\
                    ...
                    count:5b,\
                    components:{\
                        "minecraft:item_name":'{"fallback":"Helheim Key","translate":"item.yggdrasil.helheim.key"}',\
                        "minecraft:custom_data":{\
                            yggdrasil:{\
                                id:"yggdrasil.helheim.key.normal"\
                            }\
                        }\
                    }\
                },\
            ...
            {\
                buy:{\
                    ...
                    count:3,\
                    components:{\
                        "minecraft:item_name":'{"fallback":"Ominous Helheim Key","translate":"item.yggdrasil.helheim.ominous_key"}',\
                        "minecraft:custom_data":{\
                            yggdrasil:{\
                                id:"yggdrasil.helheim.key.ominous_key"\
                            }\
                        }\
                    }\
                },\
