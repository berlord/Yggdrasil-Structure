        ...
        Recipes:[\
            {\
                buy:{\
                    ...
                    count:5b,\
                    components:{\
                        "minecraft:item_name":'{"fallback":"Alfheim Key","translate":"item.yggdrasil.alfheim.key"}',\
                        "minecraft:custom_data":{\
                            yggdrasil:{\
                                id:"yggdrasil.alfheim_tree.key.normal"\
                            }\
                        }\
                    }\
                },\
            ...
            {\
                buy:{\
                    ...
                    count:3,\
                    components:{\
                        "minecraft:item_name":'{"fallback":"Ominous Alfheim Key","translate":"item.yggdrasil.alfheim.ominous_key"}',\
                        "minecraft:custom_data":{\
                            yggdrasil:{\
                                id:"yggdrasil.alfheim_tree.key.ominous_key"\
                            }\
                        }\
                    }\
                },\
